function As = returnMatrices1_7(mcPoints, Ntot, dr, Mr)
...
for newCPoints = 0:mcPoints
    ...
    % Block 3
    Zj = -dr^2 * Mr * sparse(int_vector(newCPoints));
    myA_3 = [A_3(:, 1:newCPoints); sparse(1, newCPoints);Zj];
    ...
    i2 = (2*Ntot-newCPoints + 1) * ones(newCPoints, 1);
    j2 = (Ntot - newCPoints + 1):Ntot;
    
    As{newCPoints+1}.dt2 = sparse(i2, j2, Zj/2, ...
        2*Ntot - newCPoints + 2, 2*Ntot - newCPoints + 2);
    
    % Adding the one squared to 
