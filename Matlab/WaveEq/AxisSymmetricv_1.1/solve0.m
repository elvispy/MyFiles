function [etaprob0,phiprob0,zprob0,vzprob0,errortan]=solve0(dt,z,vz,etao,phio,nr,delr,~,~,Fr,Mr,Pk)
...
[etaprob0, phiprob0, zprob0, vzprob0, ~, errortan] = ...
    getNextStep(0, 1, Eta_k, u_k, z_k, v_k, Pk, delt, ...
    delr, Ntot, Fr, Mr);
