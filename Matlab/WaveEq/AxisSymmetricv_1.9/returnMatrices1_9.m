function As = returnMatrices1_9(AA, Ntot, dr, Mr)

idx = sum(~cellfun(@isempty, AA));
As = AA;
...
for newCPoints = idx:(idx + 3)
    % Array of indexes of ones. We must do this as delta_t changes in every
    % iteration
