...
/*----------------------------------------------------------------------------*/
/*    Copyright (c) National Instruments 2004-2010.  All Rights Reserved.     */
/*----------------------------------------------------------------------------*/
/*                                                                            */
/* Title:       nilibddc.h                                                    */
...
typedef __int64		DDCFileHandle;
typedef __int64		DDCChannelGroupHandle;
typedef __int64		DDCChannelHandle;
...
/// -> Data Storage
//*****************************************************************************
/*	In addition to this function, you can also call the strongly typed 
	DDC_SetDataValues[Type] versions of this function near the bottom of this header file.
*/
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_AppendDataValues[Type] versions of this function near the bottom of this header file.
*/
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_ReplaceDataValues[Type] versions of this function near the bottom of this header file.
*/
...
int __stdcall DDC_ReplaceDataValuesTimestampComponents (DDCChannelHandle channel,
														unsigned __int64 indexOfFirstValueToReplace,
														unsigned int year[], 
														unsigned int month[], 
														unsigned int day[],
														unsigned int hour[], 
...
int __stdcall DDC_GetChannelGroups (DDCFileHandle file,
									...
									unsigned __int64 numChannelGroups);
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_GetDataValues[Type] versions of this function near the bottom of this header file.
*/
int __stdcall DDC_GetDataValues (DDCChannelHandle channel,
								 unsigned __int64 indexOfFirstValueToGet,
								 unsigned __int64 numValuesToGet,
								 void *values);
...
/// -> File
//*****************************************************************************
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_SetFileProperty[Type] functions near the bottom of this header file.
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_GetFileProperty[Type] versions of this function near the bottom of this header file.
*/
int __stdcall DDC_GetFileProperty (DDCFileHandle file,
								   const char *property,
								   void *value,
								   unsigned __int64 valueSizeInBytes);
...
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_CreateFileProperty[Type] functions near the bottom of this header file.
...
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_GetFilePropertyNameFromIndex and DDC_GetFilePropertyNameLengthFromIndex 
	functions near the bottom of this header file.
int __stdcall DDC_GetFilePropertyNames (DDCFileHandle file, 
										char** propertyNames, 
										unsigned __int64 numPropertyNames);
*/
...
//*****************************************************************************
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_SetChannelGroupProperty[Type] functions near the bottom of this header file.
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_GetChannelGroupProperty[Type] versions of this function near the bottom of this header file.
*/
...
int __stdcall DDC_GetChannelGroupStringPropertyLength (DDCChannelGroupHandle channelGroup,
													   ...
													   unsigned int *length);
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_CreateChannelGroupProperty[Type] functions near the bottom of this header file.
...
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_GetChannelGroupPropertyNameFromIndex and DDC_GetChannelGroupPropertyNameLengthFromIndex 
	functions near the bottom of this header file.
...
//*****************************************************************************
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_SetChannelProperty[Type] functions near the bottom of this header file.
...
/*	In addition to this function, you can also call the strongly typed 
	DDC_GetChannelProperty[Type] versions of this function near the bottom of this header file.
*/
...
int __stdcall DDC_GetChannelStringPropertyLength (DDCChannelHandle channel,
												  ...
												  unsigned int *length);
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_CreateChannelProperty[Type] functions near the bottom of this header file.
...
/*  You cannot call this function from Matlab. Instead, you can call the 
	DDC_GetChannelPropertyNameFromIndex and DDC_GetChannelPropertyNameLengthFromIndex 
	functions near the bottom of this header file.
